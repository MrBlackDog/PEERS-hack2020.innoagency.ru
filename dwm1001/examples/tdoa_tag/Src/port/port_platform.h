...
/* Function is used for re-initialize the SPI freq as 2MHz.
 * port_set_dw1000_slowfreq re-initialize the SPI freq as 2MHz which doesn't do
 * init state check
 */
void port_set_dw1000_slowfreq(void);
